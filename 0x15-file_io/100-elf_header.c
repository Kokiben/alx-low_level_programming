...
void print_entry(unsigned long int i_ent, unsigned char *e_ident);
...
* @e_ident: pointer to an array containing ELF magic num.
*
...
s = read(q, head, sizeof(Elf64_Ehdr));
if (s == -1)
{
free(head);
close_elf(q);
